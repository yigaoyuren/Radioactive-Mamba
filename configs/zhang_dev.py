...
class MemoryMatrixBlockConfig():
    ...
    num_memory = 4    # 4
    num_slots = 200
    slot_dim = 256 *4   # used for memory_layer_type = dim_reduce
    shrink_thres = 5
    mask_ratio = 1.0
...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        self.use_memory_inpaint_block = True#包含了Feature in-painting

        self.positive_ratio = 0.6

        self.data_root = '/home/jiao/User/yjx/SimSID-main/zhanglab'
